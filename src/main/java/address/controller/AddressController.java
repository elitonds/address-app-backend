...
public class AddressController {
	    ...
	    @GetMapping("/min_max_population")
	    public List<MinMaxPopulationDTO> getMinMaxPopulation() {
	        return service.findMinMaxPopulationByState();
	    }
	    ...
	    @GetMapping("/count_by_column/{column}")
